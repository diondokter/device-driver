...
impl<I> Device<I> {
    ...
    > {
        ...
        ::device_driver::RegisterOperation::<
            ...
            field_sets::FooRo,
            ::device_driver::RO,
        >::new(self.interface(), address as u8, field_sets::FooRo::new)
    }
    pub fn foo_rw(
        &mut self,
    ) -> ::device_driver::RegisterOperation<
    ...
    > {
        ...
        ::device_driver::RegisterOperation::<
            ...
            field_sets::FooRw,
            ::device_driver::RW,
        >::new(self.interface(), address as u8, field_sets::FooRw::new)
    }
    pub fn foo_wo(
        &mut self,
    ) -> ::device_driver::RegisterOperation<
    ...
    > {
        ...
        ::device_driver::RegisterOperation::<
            ...
            field_sets::FooWo,
            ::device_driver::WO,
        >::new(self.interface(), address as u8, field_sets::FooWo::new)
    }
}
...
pub mod field_sets {
    ...
    impl core::fmt::Debug for FieldSetValue {
        fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
            match self {
                Self::FooRo(val) => core::fmt::Debug::fmt(val, f),
                Self::FooRw(val) => core::fmt::Debug::fmt(val, f),
                Self::FooWo(val) => core::fmt::Debug::fmt(val, f),
